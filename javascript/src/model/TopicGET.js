...
import TopicGETAuthorization from './TopicGETAuthorization';
...
/**
* The TopicGET model module.
* @module model/TopicGET
* @version 1.0.0
*/
export default class TopicGET {
    /**
    ...
    */
    ...
    /**
    * Constructs a <code>TopicGET</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/TopicGET} obj Optional instance to populate.
    * @return {module:model/TopicGET} The populated <code>TopicGET</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TopicGET();
            ...
            if (data.hasOwnProperty('authorization')) {
                obj['authorization'] = TopicGETAuthorization.constructFromObject(data['authorization']);
            }
        }
        return obj;
    }
    ...
    */
    due_date = undefined;
    /**
    * @member {module:model/TopicGETAuthorization} authorization
    */
