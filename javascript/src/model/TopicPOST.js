...
/**
* The TopicPOST model module.
* @module model/TopicPOST
* @version 1.0.0
*/
export default class TopicPOST {
    /**
    * Constructs a new <code>TopicPOST</code>.
    * @alias module:model/TopicPOST
    * @class
    */
    ...
    /**
    * Constructs a <code>TopicPOST</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/TopicPOST} obj Optional instance to populate.
    * @return {module:model/TopicPOST} The populated <code>TopicPOST</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TopicPOST();
