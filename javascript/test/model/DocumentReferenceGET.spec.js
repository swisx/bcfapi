...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bcfapi.DocumentReferenceGET();
  });
  ...
  describe('DocumentReferenceGET', function() {
    it('should create an instance of DocumentReferenceGET', function() {
      // uncomment below and update the code to test DocumentReferenceGET
      //var instane = new Bcfapi.DocumentReferenceGET();
      //expect(instance).to.be.a(Bcfapi.DocumentReferenceGET);
    });
