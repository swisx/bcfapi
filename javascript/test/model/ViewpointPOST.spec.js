...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bcfapi.ViewpointPOST();
  });
  ...
  describe('ViewpointPOST', function() {
    it('should create an instance of ViewpointPOST', function() {
      // uncomment below and update the code to test ViewpointPOST
      //var instane = new Bcfapi.ViewpointPOST();
      //expect(instance).to.be.a(Bcfapi.ViewpointPOST);
    });
