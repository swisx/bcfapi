...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bcfapi.Components();
  });
  ...
  describe('Components', function() {
    it('should create an instance of Components', function() {
      // uncomment below and update the code to test Components
      //var instane = new Bcfapi.Components();
      //expect(instance).to.be.a(Bcfapi.Components);
    });
