...
(function(root, factory) {
  ...
  describe('TopicPUT', function() {
    it('should create an instance of TopicPUT', function() {
      // uncomment below and update the code to test TopicPUT
      //var instane = new Bcfapi.TopicPUT();
      //expect(instance).to.be.a(Bcfapi.TopicPUT);
    });
