...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bcfapi.VersionsGET();
  });
  ...
  describe('VersionsGET', function() {
    it('should create an instance of VersionsGET', function() {
      // uncomment below and update the code to test VersionsGET
      //var instane = new Bcfapi.VersionsGET();
      //expect(instance).to.be.a(Bcfapi.VersionsGET);
    });
