...
(function(root, factory) {
  ...
  describe('FilePUT', function() {
    it('should create an instance of FilePUT', function() {
      // uncomment below and update the code to test FilePUT
      //var instane = new Bcfapi.FilePUT();
      //expect(instance).to.be.a(Bcfapi.FilePUT);
    });
