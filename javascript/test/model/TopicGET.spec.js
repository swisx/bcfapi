...
(function(root, factory) {
  ...
  describe('TopicGET', function() {
    it('should create an instance of TopicGET', function() {
      // uncomment below and update the code to test TopicGET
      //var instane = new Bcfapi.TopicGET();
      //expect(instance).to.be.a(Bcfapi.TopicGET);
    });
