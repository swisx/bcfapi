...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bcfapi.TopicEventGET();
  });
  ...
  describe('TopicEventGET', function() {
    it('should create an instance of TopicEventGET', function() {
      // uncomment below and update the code to test TopicEventGET
      //var instane = new Bcfapi.TopicEventGET();
      //expect(instance).to.be.a(Bcfapi.TopicEventGET);
    });
