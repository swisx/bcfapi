...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Bcfapi.DocumentGET();
  });
  ...
  describe('DocumentGET', function() {
    it('should create an instance of DocumentGET', function() {
      // uncomment below and update the code to test DocumentGET
      //var instane = new Bcfapi.DocumentGET();
      //expect(instance).to.be.a(Bcfapi.DocumentGET);
    });
