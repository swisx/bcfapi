...
(function(root, factory) {
  ...
  describe('TopicPOST', function() {
    it('should create an instance of TopicPOST', function() {
      // uncomment below and update the code to test TopicPOST
      //var instane = new Bcfapi.TopicPOST();
      //expect(instance).to.be.a(Bcfapi.TopicPOST);
    });
